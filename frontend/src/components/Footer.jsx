        ...
        <div className="grid md:grid-cols-4 gap-8 mb-8">
          ...
          <div>
            ...
            <div className="flex gap-3">
              <a href="https://www.linkedin.com/company/superflycollective/?viewAsMember=true" target="_blank" rel="noopener noreferrer" className="w-8 h-8 bg-gray-800 hover:bg-[#22C55E] rounded-full flex items-center justify-center transition-colors">
                <Linkedin className="w-4 h-4" />
              </a>
              <a href="https://www.tiktok.com/@latamreportero?_r=1&_t=ZN-9531Y2FYshq" target="_blank" rel="noopener noreferrer" className="w-8 h-8 bg-gray-800 hover:bg-[#22C55E] rounded-full flex items-center justify-center transition-colors">
                <svg className="w-4 h-4" fill="currentColor" viewBox="0 0 24 24">
                  <path d="M19.59 6.69a4.83 4.83 0 0 1-3.77-4.25V2h-3.45v13.67a2.89 2.89 0 0 1-5.2 1.74 2.89 2.89 0 0 1 2.31-4.64 2.93 2.93 0 0 1 .88.13V9.4a6.84 6.84 0 0 0-1-.05A6.33 6.33 0 0 0 5 20.1a6.34 6.34 0 0 0 10.86-4.43v-7a8.16 8.16 0 0 0 4.77 1.52v-3.4a4.85 4.85 0 0 1-1-.1z"/>
                </svg>
              </a>
              <a href="https://www.instagram.com/superflycollective?igsh=MWIyaHZtMHVyenJqaQ%3D%3D&utm_source=qr" target="_blank" rel="noopener noreferrer" className="w-8 h-8 bg-gray-800 hover:bg-[#22C55E] rounded-full flex items-center justify-center transition-colors">
